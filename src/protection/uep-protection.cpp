...
{
  for (int16_t i = 0; profileTable [i].bitRate != 0; i++)
  {
...
bool uep_protection::deconvolve(int16_t *v, int32_t size, uint8_t *outBuffer)
{
  ...
  for (int32_t i = 0; i < outSize * 4 + 24; i++)
  {
    if (indexTable [i])
    {
