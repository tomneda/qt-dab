...
typedef std::string (*get_transmitterNameP) (void *, const std::string &, uint16_t, uint8_t, uint8_t);
typedef void (*get_coordinatesP) (void *, float *, float *, const std::string &, const std::string &);
