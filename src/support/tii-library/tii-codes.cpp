...
tiiHandler::tiiHandler()
{
  ...
  //Handle = dlopen("/mnt/DatenD/Programming/GIT/DAB/qt-dab/dab-maxi/build/libtii-lib.so", RTLD_NOW | RTLD_GLOBAL);
  ...
  handler = (init_tii_L != nullptr ? init_tii_L() : nullptr);
}
...
bool tiiHandler::loadFunctions()
{
  ...
  tiiFileL             = (tiiFileP)GETPROCADDRESS(this->Handle,             "tiiFileL");
  loadTableL           = (loadTableP)GETPROCADDRESS(this->Handle,           "loadTableL");
  get_transmitterNameL = (get_transmitterNameP)GETPROCADDRESS(this->Handle, "get_transmitterNameL");
  get_coordinatesL     = (get_coordinatesP)GETPROCADDRESS(this->Handle,     "get_coordinatesL");
  distanceL            = (distanceP)GETPROCADDRESS(this->Handle,            "distanceL");
  cornerL              = (cornerP)GETPROCADDRESS(this->Handle,              "cornerL");
  is_blackL            = (is_blackP)GETPROCADDRESS(this->Handle,            "is_blackL");
  set_blackL           = (set_blackP)GETPROCADDRESS(this->Handle,           "set_blackL");
