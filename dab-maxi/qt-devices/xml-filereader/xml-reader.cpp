...
static inline
TIQSmpFlt compmul(TIQSmpFlt a, float b)
{
  return TIQSmpFlt (real(a) * b, imag(a) * b);
}
...
int xml_Reader::readSamples(FILE *theFile, void (xml_Reader::*r)(FILE *theFile, TIQSmpFlt *, int))
{
  TIQSmpFlt temp[2048];
                                 ...
                                 int amount)
{
  ...
  if (fd->container == "int8")
  {
    ...
    {
      buffer [i] = TIQSmpFlt (((int8_t)lbuf [2 * i]) / 127.0,
  ...
  if (fd->container == "uint8")
  {
    ...
    for (int i = 0; i < amount; i++)
    {
      buffer [i] = TIQSmpFlt (mapTable [lbuf [2 * i]],
                                        mapTable [lbuf [2 * i + 1]]);
    }
    return;
  }
  ...
  if (fd->container == "int16")
  {
    ...
    if (fd->byteOrder == "MSB")
    {
      for (int i = 0; i < amount; i++)
      {
        ...
        buffer [i] = TIQSmpFlt ((float)temp_16_1 / scaler,
  ...
  if (fd->container == "int24")
  {
    ...
    if (fd->byteOrder == "MSB")
    {
      for (int i = 0; i < amount; i++)
      {
        ...
        buffer [i] = TIQSmpFlt ((float)temp_32_1 / scaler,
                                 ...
                                 int amount)
{
  ...
  if (fd->container == "int8")
  {
    ...
    for (int i = 0; i < amount; i++)
    {
      buffer [i] = TIQSmpFlt (((int8_t)lbuf [2 * i + 1]) / 127.0,
  ...
  if (fd->container == "uint8")
  {
    ...
    for (int i = 0; i < amount; i++)
    {
      buffer [i] = TIQSmpFlt (mapTable [2 * i + 1],
                                        mapTable [2 * i]);
    }
    return;
  }
  ...
  if (fd->container == "int16")
  {
    ...
    if (fd->byteOrder == "MSB")
    {
      for (int i = 0; i < amount; i++)
      {
        int16_t temp_16_1 = (lbuf [4 * i] << 8) | lbuf [4 * i + 1];
        int16_t temp_16_2 = (lbuf [4 * i + 2] << 8) | lbuf [4 * i + 3];
        buffer [i] = TIQSmpFlt ((float)temp_16_2 / scaler,
  ...
  if (fd->container == "int24")
  {
    ...
    if (fd->byteOrder == "MSB")
    {
      for (int i = 0; i < amount; i++)
      {
        ...
        buffer [i] = TIQSmpFlt ((float)temp_32_2 / scaler,
                                ...
                                int amount)
{
  ...
  if (fd->container == "int8")
  {
    ...
    {
      buffer [i] =
        TIQSmpFlt ((int8_t)lbuf [i] / 127.0, 0);
    }
    return;
  }
  ...
  if (fd->container == "uint8")
  {
    ...
    for (int i = 0; i < amount; i++)
    {
      buffer [i] = TIQSmpFlt (mapTable [lbuf [i]], 0);
    }
    return;
  }
  ...
  if (fd->container == "int16")
  {
    ...
    if (fd->byteOrder == "MSB")
    {
      for (int i = 0; i < amount; i++)
      {
        ...
        buffer [i] =
          TIQSmpFlt ((float)temp_16_1 / scaler, 0);
      }
    }
    else
    {
  ...
  if (fd->container == "int24")
  {
    ...
    if (fd->byteOrder == "MSB")
    {
      for (int i = 0; i < amount; i++)
      {
        ...
        buffer [i] =
          TIQSmpFlt ((float)temp_32_1 / scaler, 0);
      }
    }
    else
    {
                                ...
                                int amount)
{
  ...
  if (fd->container == "int8")
  {
    ...
    {
      buffer [i] =
        TIQSmpFlt (127.0, ((int8_t)lbuf [i] / 127.0));
    }
    return;
  }
  ...
  if (fd->container == "uint8")
  {
    ...
    for (int i = 0; i < amount; i++)
    {
      buffer [i] = TIQSmpFlt (0, mapTable [lbuf [i]]);
    }
    return;
  }
  ...
  if (fd->container == "int16")
  {
    ...
    if (fd->byteOrder == "MSB")
    {
      for (int i = 0; i < amount; i++)
      {
        int16_t temp_16_1 = (lbuf [2 * i] << 8) | lbuf [2 * i + 1];
        buffer [i] =
          TIQSmpFlt (0, (float)temp_16_1 / scaler);
      }
    }
    else
    {
  ...
  if (fd->container == "int24")
  {
    ...
    if (fd->byteOrder == "MSB")
    {
      for (int i = 0; i < amount; i++)
      {
        ...
        buffer [i] =
          TIQSmpFlt (0, (float)temp_32_1 / scaler);
      }
    }
    else
    {
