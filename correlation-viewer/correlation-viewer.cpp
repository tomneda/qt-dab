...
correlationViewer::correlationViewer(RadioInterface *mr, QSettings  *s, RingBuffer<float> *b)
  : myFrame(nullptr)
  , spectrumCurve("")
{
...
void correlationViewer::showCorrelation(int32_t dots, int marker, QVector<int> &v)
{
  uint16_t i;
  float    data[dots];
  float    mmax = 0;
